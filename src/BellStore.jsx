          ...
          <div class="flex flex-col md:flex-row items-center">
            <div class="md:w-1/2 text-left mb-4 md:mb-0 mt-20 md:mt-0 md:p-16">
              ...
              <div className="inline-flex">
                <a
                  href="https://play.google.com/store/apps/details?id=com.bellwayinfotech.bellstore_user"
                  target="_blank"
            ...
            <div class="md:w-1/2 text-right">
              <img
                loading="lazy"
                src="https://i.pinimg.com/564x/ba/c5/69/bac569e7155c021f846e1def9d3793ce.jpg"
                alt="About Image"
            ...
            <div className="flex flex-col md:flex-row  text-black">
              ...
              >
                <h2 className="text-3xl font-bold text-left mt-3">
                  Effortless Shopping with online Bell Store
                </h2>
                <p className="mt-9 text-lg" style={{ textAlign: "start" }}>
                  Say good-bye to the tiresome, traditional shopping trips and
                  hello to the future with Bellway Infotech's Online Bell Store.
                  Designed to provide you with a seamless and user-friendly
                  shopping experience, our platform is perfect for all your
                  grocery needs. Learn How to Shop Without Stress We at Bellway
                  Infotech recognize how crucial convenience is to your hectic
                  schedule. We designed our Online Bell Store to be a simple,
                  effective way to shop so you can focus more of your time on
