    ...
    return (
      <>
        <Helmet>
          ...
          <meta
            name="description"
            content="Experience the Most Delicious Meal Delivery Excellence with Bellway Infotech. Experience excellence with us today and indulge in culinary perfection. Shop  Now!"
          />
        </Helmet>
        ...
        <div class="containerx mx-auto mt-20 md:mt-0 bg-black p-8">
          <div class="flex flex-col md:flex-row items-center">
            ...
            <div class="md:w-1/2 text-right">
              <img
                loading="lazy"
                src="https://i.pinimg.com/564x/13/d6/25/13d625df3f7e7e63cfa4bc6a3ec51e90.jpg"
                alt="About Image"
