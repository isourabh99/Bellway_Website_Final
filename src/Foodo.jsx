      ...
      {images.map((image, index) => (
        ...
        >
          <img
            ...
            src={image.url}
            alt={`Image ${index + 1}`}
            className="w-full h-full object-cover rounded-xl transform transition duration-500 hover:scale-95 hover:shadow-xl"
            style={{
              maxWidth: "100%",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Experience buy the best with Bellway Infotech application for foodo service. Simplify this foodo application used with a seamless and user-friendly app. Shop now!"
        />
      </Helmet>
      ...
      <div class="containerx mx-auto bg-black p-8">
        <div class="flex  flex-col md:flex-row items-center">
          <div class="md:w-1/2  text-left mb-4 md:mb-0 pt-20 md:pt-0 md:p-16">
            <h1 class="md:text-5xl text-3xl font-bold mb-4 text-white ">
              FOODO
            </h1>
            <div className="inline-flex md:w-full">
              <a
                href="https://play.google.com/store/apps/details?id=com.foodo.customer"
                target="_blank"
                class="relative inline-flex items-center justify-center h-9 md:h-16 p-5 px-6 py-3 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out border-3 border-red-500 rounded-full shadow-md group mr-4"
              >
              ...
              <a
                href="/contact"
                class="relative inline-flex items-center justify-center h-3 md:h-16 p-5 px-6 py-3 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out border-3 border-red-500 rounded-full shadow-md group"
              >
                <span class="absolute inset-0 flex items-center justify-center w-full h-full text-white duration-300 -translate-x-full bg-red-500 group-hover:translate-x-0 ease">
                  <svg
                    class="w-6 h-6"
          ...
          <div class="md:w-1/2 text-right">
            <img
              loading="lazy"
              src="https://i.pinimg.com/736x/86/19/6a/86196a719c94e17763f55fe697f7e7dd.jpg"
              alt="About Image"
              class="w-full h-auto"
            />
          </div>
      ...
      <div class="md:w-full text-center mb-4 md:mb-0   md:p-16">
        <div className="space-y-20 mt-12  mx-auto">
          <div className="flex flex-col px-10 md:px-0 md:flex-row  text-black">
            <img
              loading="lazy"
            ...
            >
              <h2 className="text-3xl font-bold text-left mt-3">
                Welcome to Bellway Infotech's application for food service.
              </h2>
              <p className="mt-9 text-lg" style={{ textAlign: "start" }}>
                Bellway Infotech takes pride in offering high-quality digital
                solutions that meet the changing needs of both businesses and
                consumers. Our latest product, the Foodo application,
                demonstrates our dedication to excellence and innovation in the
                food service business.The Foodo app aims to transform the way
                you utilize food services. Whether you are a foodie, a busy
                professional, or a food service provider, our app aims to
                simplify and improve your interactions with food services.
              </p>
            </div>
          </div>
      ...
      <div className="bg-cover bg-center mr-4 md:mr-0   min-h-screen mt-1 ">
        <div className="container mx-auto p-4 ">
          <ImageRow images={imagesWithPositions} />
        </div>
      </div>
      <div className="flex flex-col mx-8 items-center justify-center h-screen mt-96 md:mt-24">
      ...
      <div className="w-full bg-white py-10 mt-96 md:mt-4">
        <div className="flex flex-col items-center  justify-center max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 ml-9  md:ml-7">
