    ...
    return (
      <>
        <Helmet>
          ...
          <meta
            name="description"
            content="Bellway Infotech Offers Versatile Multi-Service Solutions Tailored to Meet Diverse Needs. Discover How We Can Enhance Your Business Operations Today."
          />
        </Helmet>
        <div className="sticky-nav">
          <CNavbar />
        </div>
        <div class="containerx mx-auto bg-black mt-20 md:mt-0 p-8">
          <div class="flex flex-col md:flex-row items-center">
            ...
            <div class="md:w-1/2 text-right">
              <img
                loading="lazy"
                src="https://i.pinimg.com/564x/1d/28/7c/1d287c58077648764e6a94b69b321956.jpg"
                alt="About Image"
            ...
            <div className="flex flex-col mx-9 md:mx-0 md:flex-row  text-black">
              ...
              >
                <h2 className="text-3xl font-bold text-left mt-3">
                  Welcome to Bellway Infotech - Your Partner in Innovation and
                  Excellence
                </h2>
                <p className="mt-9 text-lg" style={{ textAlign: "start" }}>
                  Bellway Infotech recognizes that in today's fast-paced
                  environment, organizations want adaptable and dependable
                  solutions to be competitive. Our multi-service solutions are
                  intended to meet a wide range of needs, ensuring that you have
                  the necessary tools to improve your operations and achieve
                  your objectives. Custom software development involves creating
                  software solutions that are tailored to your specific business
                  needs. Mobile Application Development: Create high-performance
        ...
        <div className="bg-cover mr-4 md:mr-0 bg-center min-h-screen mt-1 ">
          <div className="container mx-auto p-4 ">
            <ImageRow images={imagesWithPositions} />
          </div>
        </div>
        <div className="flex flex-col mx-4 md:mx-0 items-center justify-center h-screen mt-96 md:mt-24">
          <h2 className="md:text-4xl text-3xl font-bold mb-8">
            Why Choose Bellway Multi Service?
          </h2>
