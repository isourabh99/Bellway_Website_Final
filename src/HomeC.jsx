    ...
    return (
      <>
        <Helmet>
          ...
          <meta
            name="description"
            content="Bellway Infotech offers the best website for house rentals, providing a seamless experience to find your ideal home. Explore our listings and find your perfect rental
"
          />
        </Helmet>
          ...
          <div class="flex flex-col md:flex-row items-center">
            <div class="md:w-1/2 text-left mb-4 md:mb-0 md:p-16">
              ...
              <div className="inline-flex">
                <a
                  href="https://play.google.com/store/apps/details?id=com.home.c"
                  target="_blank"
            ...
            <div class="md:w-1/2 text-right">
              <img
                loading="lazy"
                src="https://i.pinimg.com/736x/3e/a3/b8/3ea3b872e571cf412ad34ef0c2b045ca.jpg"
                alt="About Image"
