    ...
    return (
      <>
        <Helmet>
          ...
          <meta
            name="description"
            content="Bellway infotech online Team 11 is dedicated to innovating with cutting-edge apps, paving the way for tomorrow's digital solutions. Shop now!"
          />
        </Helmet>
        ...
        <div class="containerx mx-auto mt-20 md:mt-0 bg-black p-8">
          <div class="flex flex-col md:flex-row items-center">
            ...
            <div class="md:w-1/2 text-right">
              <img
                loading="lazy"
                src="https://i.pinimg.com/736x/5b/9a/0d/5b9a0d12e0ba996da5a5749750f071ec.jpg"
                alt="About Image"
            ...
            <div className="flex flex-col mx-9 md:mx-0 md:flex-row  text-black">
              ...
              >
                <h2 className="text-3xl font-bold text-left mt-3">
                  Welcome to Bellway Infotech's Online Team 11 - Innovating the
                  Future of Apps
                </h2>
                <p className="mt-9 text-lg" style={{ textAlign: "start" }}>
                  Online Team 11 is a groundbreaking gaming app created by
                  Bellway Infotech, designed to bring unparalleled excitement
                  and engagement to the gaming community. Our team of skilled
                  developers and designers has crafted a platform that combines
                  advanced technology with captivating gameplay.Whether you're a
                  seasoned gamer or a casual player, our app offers a unique and
                  immersive gaming experience that caters to all.
                </p>
              </div>
            </div>
          ...
          <div className="flex flex-col items-center justify-center max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="col-span-1 flex items-center justify-center">
                <img loading="lazy" src={cricket} alt="Center Image" />
              </div>
              <div className="col-span-1 ml-9 md:ml-0">
                <MainCard
