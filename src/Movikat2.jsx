...
const Product2 = () => {
    ...
    const ImageRow = ({ images }) => (
      <div className="flex flex-wrap justify-center items-center mr-3 md:mr-0 md:mt-10 space-x-4">
    ...
    return (
      <>
        <Helmet>
          ...
          <meta
            name="description"
            content="Bellway Infotech invites you to discover the ultimate movie-watching experience with Movikat, leading the way in cutting-edge technology solutions.Try it now.
"
          />
        </Helmet>
        ...
        <div class="containerx mx-auto bg-black p-8">
          <div class="flex flex-col md:flex-row items-center">
            <div class="md:w-1/2 text-left mb-4 mt-20 md:mt-0 md:mb-0 md:p-16">
            ...
            <div class="md:w-1/2  mt-3 text-right">
              <img
                loading="lazy"
                src="https://i.pinimg.com/564x/8e/78/0f/8e780f579646cc5d3613b07cceac392b.jpg"
                alt="About Image"
        ...
        <div class="md:w-full text-center mb-4 md:mb-0 mx-4 md:mx-0 md:p-16">
          ...
          <div className="space-y-20 mt-12 mx-auto">
            <div className="flex flex-col md:flex-row  text-black">
              <img
                ...
                alt="Bellway Grocery"
                className="w-full rounded-md  md:w-1/2 h-1/2"
              />
              <div
              ...
              >
                <h2 className="text-3xl font-bold text-left mt-3">
                  Welcome to Bellway Infotech - Unveiling Movikat, Your Gateway
                  to the Ultimate Movie-Watching Experience
                </h2>
                <p className="mt-9 text-lg" style={{ textAlign: "start" }}>
                  At Bellway Infotech, we are passionate about changing the way
                  you watch movies.
                  <br /> With Movikat, our most recent innovation, we deliver
                  you the greatest movie-watching experience, driven by
                  cutting-edge technology. Whether you're a casual watcher or a
                  cinephile, Movikat provides a smooth and immersive experience
                  for discovering, watching, and enjoying movies like never
                  before. Watch movies in amazing HD and 4K resolution, with
                  crystal-clear graphics and vivid colors.Our innovative
                  streaming technology provides uninterrupted playback, even on
                  slower networks. Access a large selection of movies from many
                  genres, including the most recent blockbusters, timeless
                  masterpieces, and independent gems.
                </p>
              </div>
            </div>
        ...
        <div className="w-full bg-white py-10 mt-96 md:mt-4">
          <div className="flex flex-col items-center justify-center max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="col-span-1 ml-7 md:ml-0">
                <MainCard
