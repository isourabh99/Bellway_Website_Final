    ...
    <>
      ...
      <div class="sm:mx-20 sm:w-100 p-8 my-10 mx-2 mybg text-black rounded-lg shadow-lg borderb">
        <h2 class="text-3xl font-bold mb-6 text-center  hover:text-red-600">
          "Unlock the Universe's Wonders with Go to Astro, Your Personal Cosmic
          Guide"
        </h2>
        ...
        <p class="text-black mb-6 sm:text-left  sm:mx-10">
          ...
          Experts, etc. <br /> Buy authentic and certified Gemstones, Rudraksha
          and other Astrology related items online. <br /> Book and Perform
          online poojas remotely. - Read Monthly Jyotish Sagar Magazine. - Learn
          Astrology and get certified. - Get free and premium Astrology services
          such as Horoscope, Match Making, Panchang, etc online.
          <br />
          <br />
          ...
          it's a comprehensive educational tool designed to spark curiosity and
          deepen understanding of the cosmos. Each card is meticulously crafted
          to present fascinating facts, astronomical phenomena, and celestial
          wonders in an accessible and engaging format. Whether you're a novice
          stargazer or a seasoned astronomer, Astronomy Cards offers something
          for everyone, making learning about the universe an enriching and
          ...
          stunning cards, featuring high-resolution images of celestial objects,
          nebulae, galaxies, and more. Each card is accompanied by detailed
          information, providing valuable insights into the object's
          ...
          immersive but also caters to different learning styles, ensuring that
          users can engage with the material in a way that suits them best.
          <br />
          <br />
          <h1 className="text-black text-lg font-bold">
            Customizable Learning Paths
          </h1>
          With Astronomy Cards, users have the flexibility to create customized
          learning paths tailored to their interests and preferences. Whether
          you're fascinated by the planets of our solar system, intrigued by
          black holes and supernovae, or curious about the mysteries of dark
          matter and dark energy, Astronomy Cards allows you to focus on the
          topics that captivate you the most. This personalized approach fosters
          a deeper connection with the subject matter, empowering users to
          ...
          astronomy enthusiasts, educators, and experts coming together to share
          knowledge, ask questions, and inspire each other. Through discussion
          forums, live Q&A sessions, and collaborative projects, users can
          connect with like-minded individuals from around the world, fostering
          a sense of belonging and camaraderie. Whether you're seeking guidance
          on a complex astronomical concept or eager to share your latest
          astrophotography, Astronomy Cards provides a welcoming space for
          collaboration and discovery.
          <br />
          <br />
          <h1 className="text-black text-lg font-bold">Conclusion</h1>
          In conclusion, Astronomy Cards stands as a beacon of enlightenment in
          the vast expanse of the cosmos, offering users a gateway to explore
          the wonders of astronomy like never before. Through its rich
          educational content, stunning visuals, interactive features,
          customizable learning paths, and vibrant community engagement,
          Astronomy Cards transcends the boundaries of traditional learning and
          transforms the study of the universe into an immersive and enriching
          experience.
          <br />
          <br />
        </p>
      ...
      <div className="containerx mx-auto py-8">
        ...
        <div className="relative w-full max-w-3xl mx-auto">
            ...
            >
              {slides.map((slide, index) => (
                <div key={index} className="w-full flex-shrink-0 text-center">
                  ...
                  <a
                    href={slide.url}
                    className="inline-block mt-8 bg-black text-white px-32 py-5 rounded"
                  >
                    {slide.buttonText}
                  </a>
                </div>
          ...
          <button
            ...
            className=" absolute w-9 top-1/2 left-0 transform -translate-y-1/2 bg-gray-800 text-white p-2 rounded-full"
          >
            Prev
          </button>
          <button
            onClick={goToNext}
            className=" w-9 absolute  top-1/2 right-0 transform -translate-y-1/2 bg-gray-800 text-white p-2 rounded-full"
          >
            Next
          </button>
        </div>
