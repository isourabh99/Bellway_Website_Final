...
const Product2 = () => {
    ...
    const ImageRow = ({ images }) => (
      <div className="flex flex-wrap justify-center items-center md:mt-10 space-x-4">
        {images.map((image, index) => (
          ...
          >
            <img
              ...
              src={image.url}
              alt={`Image ${index + 1}`}
              className="w-full h-full object-cover rounded-lg transform transition duration-500  hover:shadow-xl"
              style={{
                maxWidth: "100%",
    ...
    const imagesWithPositions = [
        { url: image7, position: 230, position1: -65 },
    ...
    return (
      <>
        <Helmet>
          ...
          <meta
            name="description"
            content="Give the best service with Bellway Infotech fresh delivery apps. Enjoy seamless service, easy navigation, & quick deliveries for a hassle-free experience."
          />
        </Helmet>
          ...
          <div class="flex flex-col md:flex-row items-center">
            <div class="md:w-1/2  text-left mb-4 md:mb-0 pt-20 md:pt-0 md:p-16">
              <h1 class="md:text-5xl text-3xl font-bold mb-4 text-white ">
                FRESH AND RED DELIVERY
              </h1>
              <div className="inline-flex md:w-full">
                <a
                  href="https://play.google.com/store/apps/details?id=com.bellwayinfotech.freshnred_user"
                  target="_blank"
                  class="relative inline-flex items-center justify-center h-3 md:h-16 p-5 px-6 py-3 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out border-3 border-red-500 rounded-full shadow-md group mr-4"
                >
        ...
        <div class="md:w-full text-center mb-4 md:mb-0  md:p-16">
          ...
          <div className="space-y-20  mt-3   md:mt-12 mx-auto">
            <div className="flex flex-col mx-6 md:mx-0  md:flex-row  text-black">
              <img
                loading="lazy"
              ...
              >
                <h2 className="text-3xl font-bold text-left mt-3">
                  A Bellway food application provides numerous benefits for
                  users:
                </h2>
                <p className="mt-9 text-lg" style={{ textAlign: "start" }}>
                  Convenience: Food applications offer the convenience of
                  browsing menus, placing orders, and making payments directly
                  from your smartphone or computer. This eliminates the need for
                  phone calls or physical visits to restaurants, saving time and
                  effort.
                  <br />
                  <br />
                  Variety of Choices: These apps provide a wide range of
                  restaurants and cuisines to choose from, allowing users to
                  explore diverse options in their area. Whether you crave
                  pizza, sushi, or vegan dishes, you can easily find and order
                  your favorite meals.
                </p>
              </div>
            </div>
            <div className="flex flex-col items-center justify-center mt-20">
              <div className="mt-4 md:mt-0 text-center md:text-left mx-3 md:mx-9">
        ...
        <div className="bg-cover bg-center mr-5 md:mr-0 min-h-screen mt-1 ">
        ...
        <div className="w-full bg-white py-10 mt-96  md:mt-4">
          <div className="flex flex-col items-center justify-center max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="col-span-1 ml-9 md:ml-0">
                <MainCard
              ...
              <div className="col-span-1 flex items-center justify-center">
                <img
                  loading="lazy"
                  src="https://i.pinimg.com/564x/8a/b5/26/8ab5268f69ebe69e04ef76ba6a6447a2.jpg"
                  alt="Center Image"
                />
              </div>
              <div className="col-span-1 ml-9 md:ml-0">
