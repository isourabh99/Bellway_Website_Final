    ...
    return (
      <>
        ...
        <div class="containerx mx-auto bg-black p-8">
          <div class="flex flex-col md:flex-row items-center">
            ...
            <div class="md:w-1/2 text-right">
              <img
                loading="lazy"
                src="https://i.pinimg.com/564x/00/16/ae/0016ae4a066550e4e145c1ca74c8e6e0.jpg"
                alt="About Image"
        ...
        <div class="md:w-full text-center mb-4 md:mb-0 md:p-16">
          ...
          <div className="space-y-20 mt-12  md:mx-auto ">
        ...
        <div className="bg-cover bg-center mr-4 md:mr-0 min-h-screen md:mt-1 ">
