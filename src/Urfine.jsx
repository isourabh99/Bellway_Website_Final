    ...
    return (
      <>
        <Helmet>
          ...
          <meta
            name="description"
            content="Experience seamless scheduling with Bellway Infotech ur fine comprehensive service appointment. Enjoy efficient, user-friendly service for all your needs.
"
          />
        </Helmet>
          ...
          <div class="flex flex-col md:flex-row items-center">
            <div class="md:w-1/2 text-left mb-4 md:mb-0 md:p-16">
              ...
              <div className="inline-flex">
                <a
                  href="https://play.google.com/store/apps/details?id=com.bellwayinfotech.urfine"
                  target="_blank"
            ...
            <div class="md:w-1/2 text-right">
              <img
                loading="lazy"
                src="https://i.pinimg.com/564x/5e/a6/21/5ea621de2522c3d61804ae12345f5697.jpg"
                alt="About Image"
            ...
            <div className="flex flex-col mx-9 md:mx-0 md:flex-row  text-black">
              ...
              >
                ...
                <p className="mt-9 text-lg" style={{ textAlign: "start" }}>
                  Scheduling and monitoring service appointments might be
                  difficult, but with Bellway Infotech's UR FINE complete
                  solution, the process is simplified and efficient. Bellway
                  Infotech provides a simplified, user-friendly platform that
                  meets all of your service scheduling requirements, delivering
                  a seamless and organized experience.Wide Range of Services:
                  Healthcare Appointments: Schedule appointments with doctors,
                  specialists, and other healthcare providers easily. Schedule
                  home services such as plumbing, electrical work, and cleaning.
                  Automotive Services: Schedule appointments for car
