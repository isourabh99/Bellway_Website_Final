...
import CaseSlider from './CaseSlider6.jsx'
    ...
    <>
      ...
      <div class="containerx mx-auto bg-black pt-32 md:pt-0 md:p-8">
        <div class="flex flex-col md:flex-row items-center">
          <div class="md:w-1/2 text-left mb-4 md:mb-0 md:p-16">
            <h1 class="md:text-5xl text-3xl font-bold mb-4 text-white ">LLN</h1>
          ...
          <div class="md:w-1/2 mx-3 my-4 md:mx-0 md:my-0 text-right">
            <img
              loading="lazy"
              src="https://i.pinimg.com/564x/8b/7c/8d/8b7c8dbbad233d64c5f90ff715a5e954.jpg"
              alt="About Image"
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between p-8">
        ...
        <div className="md:w-1/2 mb-8 md:mb-0">
          <h4 className="text-3xl font-bold mb-4 md:ml-20">About LLN</h4>
          <p className="text-gray-700 md:ml-20 text-lg text-justify md:text-xl">
            LLN is a robust app utilized by institutions for organizing quizzes
            and exams efficiently. It provides a comprehensive platform where
            educators can create, manage, and administer assessments seamlessly.
            Students benefit from a user-friendly interface that supports
            various question formats and real-time feedback, enhancing their
            learning experience. LLN helps institutions streamline assessment
            processes, ensuring accuracy and efficiency in evaluating student
          ...
          <div className="inset-x-0 top-0 transform translate-y-8 mx-4 ">
            ...
            >
              <div className="bg-black bg-opacity-50 p-6 rounded-lg mb-26">
                <h3 className="text-3xl font-bold my-3 md:my-0 text-white text-center">
      ...
      <div className=" text-white mt-20 font-sans min-h-screen">
        <div
        ...
        >
          <div className="bg-black bg-opacity-50 p-8">
            ...
            <p className="text-lg mt-8 text-justify md:ml-24">
              The urgent integration of educational and technological realms
              with <br />
              robust regulatory compliance is crucial now more than ever. In
              educational <br />
              settings, there is a growing recognition of the benefits of
              digital platforms <br /> in enhancing learning outcomes and
              accessibility. Institutions are increasingly <br />
              adopting technologies that support remote learning and assessment,
              responding <br />
              to the evolving needs of students and educators alike. In response
              to these <br />
              educational challenges, our client swiftly introduced LLN, an
              advanced app designed <br /> for institutions to streamline the
              organization of quizzes and exams. This innovative <br /> solution
              supports educators in creating assessments, delivering them
              securely,
              <br /> and providing real-time feedback to students.
            </p>
      ...
      <div className="text-black p-8">
        ...
        <p className="text-lg mt-6 text-justify md:text-center max-w-4xl mx-auto">
          Our client's objective was to rapidly deploy LLN, an advanced app
          designed to revolutionize educational assessments. This solution aims
          to empower institutions by providing a seamless platform for
          organizing quizzes and exams.
        </p>
        ...
        <ul className="list-disc list-inside text-lg mt-4 max-w-4xl md:ml-24 ">
          ...
          <li className="text-black">
            Offer cost-effective assessment management
          </li>
        </ul>
      </div>
      ...
      <div className=" text-white font-sans min-h-screen">
        ...
        >
          <div className="bg-black bg-opacity-50 p-7">
            ...
            <p className="text-lg mt-8 md:ml-24 my-4 md:my-0 text-center">
            ...
            <div className="md:relative mr-9 space-y-4 md:space-y-0 md:mr-0 md:h-36">
              <img
                loading="lazy"
                src="https://i.pinimg.com/736x/ad/28/f9/ad28f9c583b507a5c084a20976271f1f.jpg"
                alt="Image 1"
                className="md:absolute rounded-md w-[31rem] h-[28rem] left-[44rem] bottom-[27rem] transform translate-x-4 translate-y-4"
              />
              <img
                loading="lazy"
