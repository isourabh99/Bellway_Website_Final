...
import CaseSlider7 from './CaseSlider7.jsx'
    ...
    <>
      ...
      <div class="containerx mx-auto bg-black pt-32 md:pt-0 md:p-8">
        <div class="flex flex-col md:flex-row items-center">
          ...
          <div class="md:w-1/2 mx-3 md:mx-0 my-4 md:my-0 text-right">
            <img
              loading="lazy"
              src="https://i.pinimg.com/736x/57/4f/ff/574fffd52d97107c86d89b8ce9d7e8fe.jpg"
              alt="About Image"
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between p-8">
        ...
        <div className="md:w-1/2 mb-8 md:mb-0">
          <h4 className="text-3xl font-bold mb-4 md:ml-20">About Maza Munch</h4>
          <p className="text-gray-700 md:ml-20 text-lg text-justify md:text-xl">
            Maza Munch is a user-friendly food ordering platform that connects
            users with nearby restaurants, allowing them to browse and order
            their favorite meals with ease. The app simplifies the dining
            experience by offering features like real-time menu updates,
            customizable order options, and secure payment methods. Users can
            search for restaurants based on cuisine, location, or popularity,
            and can opt for delivery or pickup. Maza Munch aims to enhance
            customer satisfaction by providing a convenient, accessible, and
            enjoyable way to discover and enjoy delicious food from local
            eateries.
          </p>
        </div>
