      ...
      <>
        <div className="app-maint">
          ...
          <div className="glass-card">
            <h2>Delicious Meals Delivery</h2>
            <hr />
            <p>
        ...
        <div className="app-main2t">
          <div className="glass-card2">
            ...
            <p className="p2">
              {" "}
              Delicious Meals Delivery Service <hr />
            </p>
            <br />
            <p className="p3">
              ...
              is <br /> designed to provide you with a convenient and flavorful
              dining experience, offering a wide variety <br />
              of delectable dishes delivered straight to your doorstep. <br />
              <br />
              Have specific dietary requirements or preferences? Customize your
              order accordingly. Whether it's <br />
              vegan, gluten-free, or extra spicy, we aim to cater to your unique
              needs. <br />
              <br />
              Planning a family dinner or a meal with friends? The app makes it
              easy to place large orders, <br />
              ensuring everyone gets their favourite dish.
            </p>
            <div>
