...
"
        ...
        <div class="containerx mx-auto mt-20 md:mt-0 bg-black p-8">
          <div class="flex flex-col md:flex-row items-center">
            <div class="md:w-1/2 text-left mb-4 md:mb-0 md:p-16">
              ...
              <div className="inline-flex">
                <a
                  href="https://play.google.com/store/apps/details?id=com.daily.bills"
                  target="_blank"
            ...
            <div class="md:w-1/2 text-right">
              <img
                loading="lazy"
                 src="https://i.pinimg.com/736x/24/a1/34/24a134ea17ceea3e94d24f5174c4c820.jpg"
                alt="About Image"
        ...
        <div class="md:w-full text-center mb-4 md:mb-0 md:p-16">
          ...
          <div className="space-y-20 mt-12 mx-auto">
            <div className="flex mx-9 md:mx-0 flex-col md:flex-row  text-black">
              <img
              ...
              >
                <h2 className="text-3xl font-bold text-left mt-10">
                  Billing Simplified Daily
                </h2>
                <p className="mt-9 text-lg" style={{ textAlign: "start" }}>
                  Bellway Infotech understands the intricacies and issues that
                  come with regular billing operations. Our objective is to
                  provide organizations with smooth, efficient, and simplified
                  billing solutions that are suited to your specific needs. Why
                  Choose Bellway Infotech? Streamlined Processes: Our unique
                  billing software automates regular operations, avoids manual
                  errors, and guarantees that your billing processes run
                  smoothly and efficiently. User-Friendly design: Designed with
                  the user in mind, our design is straightforward and simple to
                  use, allowing your team to get up and running quickly.
                  Real-time analytics and reporting provide insights into your
                  billing processes. Stay informed and make data-driven
        ...
        <div className="bg-cover mr-4 md:ml-0 bg-center min-h-screen mt-1 ">
        ...
        <div className="flex flex-col items-center justify-center h-screen mt-96 md:mt-24">
          <h2 className="nd:text-4xl text-3xl font-bold mb-8">
