    ...
    <>
      ...
      <div class="sm:mx-20 sm:w-100 p-8 my-10 mx-2 mybg text-black rounded-lg shadow-lg borderb">
        <h2 class="text-3xl font-bold mb-6 text-center  hover:text-red-600">
          "Experience Next-Level Nutrition with Calorie Care's Cutting-Edge App"
        </h2>
        ...
        <p class="text-black mb-6 sm:text-left  sm:mx-10">
          ...
          individuals seeking health-conscious meal options that prioritize both
          taste and well-being. Whether you're a busy professional, a fitness
          enthusiast, or someone looking to make healthier food choices, Calorie
          Care provides a convenient platform to access a wide array of
          nutritious meals tailored to your dietary preferences and lifestyle.
          <br />
          <br />
          <h1 className="text-black text-lg font-bold">
            Curated Meal Plans and Options
          </h1>
          With Calorie Care, you gain access to a meticulously curated selection
          of meal plans and options, each designed by expert nutritionists and
          chefs to meet specific health goals and dietary requirements. From
          weight management to muscle gain, diabetic-friendly to gluten-free,
          our diverse range of meal options ensures that there's something for
          everyone. Whether you're looking for a quick and healthy breakfast, a
          satisfying lunch, or a wholesome dinner, Calorie Care has you covered
          with delicious and nutritious meals that fuel your body and mind.
          <br />
          <br />
          <h1 className="text-black text-lg font-bold">
          ...
          dietary needs, which is why Calorie Care offers customizable delivery
          preferences tailored to your schedule and lifestyle. Whether you
          prefer daily deliveries to ensure freshness, weekly meal plans for
          added convenience, or on-demand ordering for flexibility, our app
          allows you to personalize your delivery schedule according to your
          needs. With Calorie Care, you can enjoy the convenience of healthy
          eating without compromising on your busy lifestyle.
          <br />
          <br />
          <h1 className="text-black text-lg font-bold">
          ...
          suppliers and prepare our meals with care and attention to detail. Our
          team of experienced chefs crafts each dish to perfection, ensuring
          optimal taste, texture, and nutritional value. With Calorie Care, you
          can trust that every meal is not only delicious but also packed with
          essential nutrients to support your overall health and well-being.
          <br />
          <br />
          <h1 className="text-black text-lg font-bold">
          ...
          living. This sense of camaraderie and encouragement motivates users to
          stay committed to their health goals and inspires them to make
          ...
          convenience, offering users a comprehensive solution to their dietary
          needs. With a diverse range of curated meal plans and options,
          customizable delivery preferences, and a commitment to quality
          ingredients and preparation, Calorie Care provides a seamless and
          convenient way to maintain a nutritious diet in today's fast-paced
          world.
          <br />
          <br />
        </p>
