  ...
  const ImageRow = ({ images }) => (
    <div className="flex flex-wrap justify-center items-center mt-10 space-x-4">
      {images.map((image, index) => (
        <div
          key={index}
          className=" static md:relative   w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5 p-2"
    ...
    <>
      ...
      <div class="containerx mx-auto bg-black p-8">
        <div class="flex flex-col md:flex-row items-center">
          <div class="md:w-1/2 md:text-left mb-4 pt-20 md:pt-0 md:mb-0 md:p-16">
            <h1 class="md:text-5xl text-3xl font-bold mb-4 text-white ">
              BELLWAY GROCERY
            </h1>
            <h2
              class="sm:text-2xl mb-4 text-white"
              style={{ textAlign: "left" }}
            >
              application offering Blinkit Clone of cuisines, easy ordering, and
              seamless delivery.
            </h2>

            <div className=" inline-flex   md:w-full">
              <a
                href="https://play.google.com/store/apps/details?id=com.b2bgrocery.user"
                target="_blank"
                class="relative inline-flex items-center justify-center p-5  h-3 md:h-14    px-6 py-3 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out border-3 border-red-500 rounded-full shadow-md group mr-4"
              >
                <span class="absolute inset-0 flex items-center justify-center  md:w-full md:h-full text-white duration-300 -translate-x-full bg-red-500 group-hover:translate-x-0 ease">
                  <svg
                    class="w-6 h-6"
                    fill="none"
                    stroke="currentColor"
                ...
                <span class="absolute flex items-center justify-center   md:w-full md:h-full text-red-500 transition-all duration-300 transform group-hover:translate-x-full ease">
                  View Demo
                </span>
              ...
              <a
                href="/contact"
                class="relative inline-flex items-center justify-center h-3 md:h-14 p-5 px-6 py-3 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out border-3 border-red-500 rounded-full shadow-md group"
              >
        ...
        <div className="space-y-20  mt-12 mx-auto">
          <div className="flex flex-col md:flex-row  text-black">
            ...
            <div
              ...
              className="md:ml-28 mt-1 md:mt-0 text-center md:text-left"
            >
              <h2 className="text-3xl font-bold text-left">
                From Aisles to Your Doorstep: Experience Seamless Grocery App
                Delivery
              </h2>
              <p className="mt-9 text-lg" style={{ textAlign: "start" }}>
                Bellway Infotech is the organization that best understands
                convenience in today's fast-paced environment. Grocery shopping
                has never been easier, thanks to our Fresh Delivery Apps. Enjoy
                rapid deliveries, easy navigation, and courteous service.
                Discover why we help thousands of individuals with their daily
                requirements. Smooth shopping experience: Browse and purchase
                with ease. The user-friendly design of our app allows you to
                quickly find everything you need.
              </p>
            </div>
          </div>
          <div className="flex  flex-col items-center justify-center md:mt-20">
            <div className="mt-4 md:mt-0 text-center md:text-left md:mx-9">
              ...
              <div
                ...
                className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12 md:p-3"
              >
                {cardData.map((card, index) => (
                  <div
                    key={index}
                    className="bg-[#9ADE7B] rounded-lg p-6 shadow-md transform transition duration-500 hover:scale-105 hover:shadow-2xl md:text-nowrap "
                  >
      ...
      <div className="flex  flex-col m items-center justify-center md:h-screen md:mt-24">
        <h2 className="text-4xl font-bold  mb-8">
          Why Choose Bellway Grocery?
        </h2>
      ...
      <div className="w-full  bg-white py-10 mt-4">
        <div className="flex flex-col items-center justify-center max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 ml-8  md:ml-0 md:grid-cols-3 gap-8">
            ...
            <div className="col-span-1 flex items-center justify-center">
              <img
                loading="lazy"
                src="https://i.pinimg.com/564x/02/e8/23/02e823b4b541db774b26f845a0c66aaa.jpg"
                alt="Center Image"
